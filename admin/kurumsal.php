<?php require("../include/baglan.php");include("../include/fonksiyon.php");
		...
		define('TABLE',"kurumsal");
		define('AREA',"kurumsal");
		if(!isset($do)) $do = null;
		$sayfa = (isset($q) ? $q : 1);
					...
					if(!empty($_POST['haber_baslik']) || !empty($_POST['haber_aciklama'])) {
						...
						foreach ($_POST AS $k=>$v) {
							...
							if (substr($k,0,5) == "form_") {
								...
								$insert = $db->prepare("INSERT INTO ".TABLE." SET haber_baslik = ?, haber_seo = ?, haber_aciklama = ?, haber_description = ?,   haber_kisaaciklama = ?,    haber_kalite = ?,      haber_yillik = ?,    haber_resim = ?,  dil_id = ?, haber_durum = ?, haber_ust_id = ?");
								$insert->execute(array($haber_baslik[$key], Seo_Link_Cevir($haber_baslik[$key]), $haber_aciklama[$key], $haber_description[$key],   $haber_kisaaciklama[$key],   $haber_kalite[$key],   $haber_yillik[$key], $haber_resim,  $key, $haber_durum, $LastID));
...
?>
												<div class="step-tab-panel" data-step="step<?php echo $LANGUAGE_ID; ?>">
													<div class="row">
														...
														<div class="col-lg-12 mb-2">
															<div class="form-group">
																<label class="text-label"><i class="flag-icon flag-icon-<?php echo $LANGUAGE_CODE; ?> icon-2x"></i> Misyonumuz</label>
																<textarea class="form-control" name="haber_description[<?php echo $LANGUAGE_CODE; ?>]"></textarea>
															</div>
														</div>

														<div class="col-lg-12 mb-2">
															<div class="form-group">
																<label class="text-label"><i class="flag-icon flag-icon-<?php echo $LANGUAGE_CODE; ?> icon-2x"></i> Vizyonumuz</label>
																<textarea class="form-control" name="haber_kisaaciklama[<?php echo $LANGUAGE_CODE; ?>]"></textarea>
															</div>
														</div>

														<div class="col-lg-12 mb-2">
															<div class="form-group">
																<label class="text-label"><i class="flag-icon flag-icon-<?php echo $LANGUAGE_CODE; ?> icon-2x"></i> Kalite Politikamız</label>
																<textarea class="form-control" name="haber_kalite[<?php echo $LANGUAGE_CODE; ?>]"></textarea>
															</div>
														</div>

														<div class="col-lg-12 mb-2">
															<div class="form-group">
																<label class="text-label"><i class="flag-icon flag-icon-<?php echo $LANGUAGE_CODE; ?> icon-2x"></i> Yıllık Tecrübe (Sayı)</label>
																<input type="text" name="haber_yillik[<?php echo $LANGUAGE_CODE; ?>]" class="form-control" placeholder="Yıllık Tecrübe (Sayı)" required="">
															</div>
														</div>
												...
												<div class="step-tab-panel" data-step="step<?php echo $LANGUAGE_ID; ?>">
													<div class="row">
														...
														<div class="col-lg-12 mb-2">
															<div class="form-group">
																<label class="text-label"><i class="flag-icon flag-icon-<?php echo $LANGUAGE_CODE; ?> icon-2x"></i> Misyonumuz</label>
																<textarea class="form-control" name="haber_description[<?php echo $LANGUAGE_CODE; ?>]"><?php echo GetTableValue("haber_description",TABLE,"where haber_ust_id = {$id} and dil_id = '{$LANGUAGE_CODE}' "); ?></textarea>
															</div>
														</div>
														<div class="col-lg-12 mb-2">
															<div class="form-group">
																<label class="text-label"><i class="flag-icon flag-icon-<?php echo $LANGUAGE_CODE; ?> icon-2x"></i> Vizyonumuz</label>
																<textarea class="form-control" name="haber_kisaaciklama[<?php echo $LANGUAGE_CODE; ?>]"><?php echo GetTableValue("haber_kisaaciklama",TABLE,"where haber_ust_id = {$id} and dil_id = '{$LANGUAGE_CODE}' "); ?></textarea>
															</div>
														</div>
														<div class="col-lg-12 mb-2">
															<div class="form-group">
																<label class="text-label"><i class="flag-icon flag-icon-<?php echo $LANGUAGE_CODE; ?> icon-2x"></i> Kalite Politikamız</label>
																<textarea class="form-control ckeditor" name="haber_kalite[<?php echo $LANGUAGE_CODE; ?>]"><?php echo GetTableValue("haber_kalite",TABLE,"where haber_ust_id = {$id} and dil_id = '{$LANGUAGE_CODE}' "); ?></textarea>
															</div>
														</div>
														<div class="col-lg-12 mb-2">
															<div class="form-group">
																<label class="text-label"><i class="flag-icon flag-icon-<?php echo $LANGUAGE_CODE; ?> icon-2x"></i> Kaç Yıllık Tecrübe</label>
																<textarea class="form-control " name="haber_yillik[<?php echo $LANGUAGE_CODE; ?>]"><?php echo GetTableValue("haber_yillik",TABLE,"where haber_ust_id = {$id} and dil_id = '{$LANGUAGE_CODE}' "); ?></textarea>
															</div>
														</div>
